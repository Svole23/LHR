...
const actions = {
  ...
  LOAD_PAGES ({ commit, dispatch }, locale) {
    ...
    let includes = [
      'fields.image',
      'fields.technologies_page_image',
      'fields.technology_hero_image',
      'fields.technology_image_one',
      'fields.technology_image_two',
      'fields.references_image_one',
      'fields.references_image_two',
      'fields.technology_intro_image',
      'fields.brochure'
      ...
      let getRelation = (field, key) => {
        ...
        if (_.isObject(field) && field !== null) {
          if ('id' in field && 'type' in field && field.type == 'entity') {
            let relatedPage = pages.find(p => p.id === field.id)
            // let relation = decoratePage(relatedPage)
            //console.log("Relation", field, relation, relatedPage);
            return relatedPage
          }
        }
